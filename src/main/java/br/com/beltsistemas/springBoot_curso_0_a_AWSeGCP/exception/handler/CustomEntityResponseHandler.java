...
public class CustomEntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ResourceNotFoundException.class) // Trata a exceção ResourceNotFoundException (toda a vez que essa classe for chamada irá cair nesse handler)
    ...
    @ExceptionHandler(RequiredObjectIsNullException.class) // Trata a exceção RequiredObjectIsNullException (toda a vez que essa classe for chamada irá cair nesse handler)
